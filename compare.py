...
from models import SVMModel, GradientBoostingModel, RandomForestModel, MLPModel, handle_datetime, handle_rainfall
...
def main():
  ...
  numerical_features = ["COUGM3", "NO2UGM3", "O3UGM3", "PM25", "SO2UGM3", "UV_INDEX"]
